...
This firmware targets A2Pico-lite and uses a USB thumb drive as its storage medium. The thumb drive must be formatted with FAT, FAT32, or exFAT.

Now, with the flashed A2Pico-lite and the formatted USB thumb drive at hand, perform the following steps:

1. Download the Total Replay .hdv file from https://archive.org/details/TotalReplay and save it as the only file in the root directory of the USB thumb drive.

2. Insert the USB thumb drive into the A2Pico-lite and plug the A2Pico-lite into an Apple II slot of your choice. We recommend slot 7.
